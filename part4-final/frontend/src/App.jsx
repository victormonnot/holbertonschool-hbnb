      ...
      >
          ...
          <div className="nav-links">
            {NAV_LINKS.map((link) => (
              <a
                ...
                onMouseLeave={(e) => {
                  if (!link.active) e.target.style.color = 'rgba(255,255,255,0.6)';
                }}
              >
                {link.label}
              </a>
        ...
        >
          ...
          <motion.p
            ...
            className="hero-sub"
          >
            Découvrez des hébergements uniques à travers le système solaire. Nos
            habitats pressurisés et notre ingénierie de pointe rendent le séjour
            spatial accessible — sûr et extraordinaire.
          </motion.p>
